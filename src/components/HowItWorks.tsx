      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            {steps.map((step, index) => <div key={index} className={`flex flex-col lg:flex-row items-center gap-8 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                {/* Content */}
                <div className="flex-1 lg:w-1/2">
                  <div className={`bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ${index % 2 === 1 ? 'lg:text-right' : ''}`}>
                    ...
                    <ul className="space-y-3">
                      {step.details.map((detail, idx) => <li key={idx} className="flex items-center text-gray-700">
